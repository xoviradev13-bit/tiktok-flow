# -*- coding: utf-8 -*-
"""
Apply Real Values from Quote (Bao_gia_TikTok_Account_Management_MVP_chuan.docx)
and User Details to Contract (Mau_Hop_Dong_Phat_Trien_Phan_Mem_Viet_Nam_Comprehensive_v2.docx)
"""
...
def add_signature_block(doc, rep_a="[Họ và tên Người đại diện]", rep_b="Nguyễn Tiến Đạt", role_a="[Chức vụ]", role_b="Bên cung cấp dịch vụ"):
...
print("Building customized contract with real values...")
