        ...
        <div className="max-w-[1850px] mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 gap-4">
            ...
            <div className="flex items-center gap-1.5 sm:gap-2.5 shrink-0">
              ...
              {/* Currency Dropdown Menu with Tooltip */}
              <DropdownMenu>
                <Tooltip>
                  <TooltipTrigger asChild>
                    <DropdownMenuTrigger asChild>
                      <button
                        type="button"
                        className="relative flex items-center justify-center gap-1.5 h-9 px-2.5 rounded-xl bg-white dark:bg-slate-900 hover:bg-slate-100 dark:hover:bg-slate-800 border border-slate-200 dark:border-slate-800 text-slate-700 dark:text-slate-300 transition-all active:scale-95 shadow-xs cursor-pointer focus:outline-none text-xs font-bold"
                        aria-label="Đổi đơn vị tiền tệ hiển thị"
                      >
                        {currency === "USD" ? (
                          <>
                ...
                <DropdownMenuContent
                  align="end"
                  sideOffset={6}
                  className="w-56 p-1.5 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-xl space-y-0.5 z-50 animate-in fade-in-0 zoom-in-95"
                >
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span>USD (Đô la Mỹ)</span>
                    </div>
                    {currency === "USD" && <Check className="w-3.5 h-3.5 text-emerald-500" />}
                  </DropdownMenuItem>
                  ...
                  >
                    ...
                    {currency === "VND" && <Check className="w-3.5 h-3.5 text-pink-500" />}
                  </DropdownMenuItem>
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span>GBP (Bảng Anh)</span>
                    </div>
                    {currency === "GBP" && <Check className="w-3.5 h-3.5 text-purple-500" />}
                  </DropdownMenuItem>
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span>EUR (Đồng Euro)</span>
                    </div>
                    {currency === "EUR" && <Check className="w-3.5 h-3.5 text-blue-500" />}
                  </DropdownMenuItem>

                  {rates?.USD_VND && (
                    <div className="pt-1 mt-1 border-t border-slate-100 dark:border-slate-800/60 px-2.5 py-1 text-[10.5px] text-slate-400 font-mono flex flex-col gap-0.5">
                      <div>1 USD ≈ {rates.USD_VND.toLocaleString("vi-VN")} ₫</div>
                      {rates.GBP_USD && <div>1 GBP ≈ ${rates.GBP_USD.toFixed(2)} USD</div>}
                    </div>
                  )}
                </DropdownMenuContent>
              </DropdownMenu>
